...
com.cocoafish.js.sdk.XD = {
  ...
  init: function(channelUrl) {
    ...
    if (window.addEventListener && window.postMessage && (com.cocoafish.js.sdk.utils.BrowserDetect.browser !== com.cocoafish.constants.ie)) {
...
com.cocoafish.js.sdk.UIManager = {
  ...
  popup: function(call) {
    ...
    var
      ...
      features = (
        'location=0,scrollbars=1,width=' + width +
        ',height=' + height +
        ',left=' + left +
        ',top=' + top
      );
